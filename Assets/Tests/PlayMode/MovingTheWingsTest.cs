...
public class MovingTheWingsTest
{
    ...
    public IEnumerator PlayerCanJump()
    {
        ...
        // Espera un frame para permitir que el controlador se actualice despu�s del salto
        yield return null;
    ...
    public IEnumerator PlayerCollidesWithFloor()
    {
        ...
        // Mueve al jugador hacia abajo para simular una colisi�n con el suelo
        playerController.transform.position = finalPos;

        // Espera un frame para permitir que el controlador se actualice y detecte la colisi�n
        yield return null;
